...
Source0  : https://files.pythonhosted.org/packages/31/a4/b03a16637574312c1b54c55aedeed8a4cb7d101d44058d46a0e5706c63e1/pycryptodomex-3.20.0.tar.gz
...
%prep
%setup -q -n pycryptodomex-3.20.0
cd %{_builddir}/pycryptodomex-3.20.0
pushd ..
cp -a pycryptodomex-3.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704902537

...
Source0  : https://files.pythonhosted.org/packages/3f/13/84f2aea851d75e12e7f32ccc11a00f1defc3d285b4ed710e5d049f31c5a6/pycryptodomex-3.19.1.tar.gz
...
%prep
%setup -q -n pycryptodomex-3.19.1
cd %{_builddir}/pycryptodomex-3.19.1
pushd ..
cp -a pycryptodomex-3.19.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703779996

...
Source0  : https://files.pythonhosted.org/packages/c9/85/e24bf90972a30b0fcd16c73009add1d7d7cd9140c2498a68252028899e41/pycryptodomex-3.23.0.tar.gz
...
%prep
%setup -q -n pycryptodomex-3.23.0
cd %{_builddir}/pycryptodomex-3.23.0
pushd ..
cp -a pycryptodomex-3.23.0 buildavx2
popd
pushd ..
cp -a pycryptodomex-3.23.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747669561
